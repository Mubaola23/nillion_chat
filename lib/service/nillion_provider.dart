...
import 'package:nillion_chat/service/nillion_chat_session.dart';
...
class NillionProvider extends LlmProvider with ChangeNotifier {
  ...
  // NillionChatSession? _startChat(Iterable<ChatMessage>? history) => _model.startChat(
