...
import 'package:nillion_chat/service/utils/mutex.dart';
...
/// response.
final class NillionChatSession {
...
extension StartChatExtension on GenerativeModel {
  /// Starts a [NillionChatSession] that will use this model to respond to messages.
  ///
  /// ```dart
